#Notes from Intro to Git on July 30, 2025

#1. Make a new repo on GitHub 
#2. Add this repo to personal computer using git clone
     git clone <repository_url>  
#3. Make a new README file.
    #Lots of options.  The command favoured by the instructor was:
code README
# which opened up a file in VS Code
